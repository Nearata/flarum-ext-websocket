...
use Nearata\Websocket\Api\Controller\ExpireTokenController;
...
return [
    ...
    (new Extend\Routes('api'))
        ...
        ->post('/nearata/websocket/refreshToken', 'nearata-websocket.refresh-token', RefreshTokenController::class),
